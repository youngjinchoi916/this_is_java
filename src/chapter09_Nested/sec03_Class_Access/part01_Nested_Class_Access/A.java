...
public class A {
	 ...
	 * 		-> 정적 멤버 클래스 : 바깥 클래스의 모든 필드의 초기값 선안, 모든 메소드에서 객체를 생성할 수 있다.
	 */
	
	//인스턴스 필드
	/*
	 * 인스턴스 멤버 클래스 -> 바깥클래스의 인스턴스 필드로 선언 가능
	 * 정적 멤버 클래스 -> 바깥클래스의 인스턴스 필드로 선언 가능
	...
	void instanceMethod() {
		/*
		 * 인스턴스 멤버 클래스 -> 바깥클래스의 인스턴스 메소드에서 객체 생성 가능
		 * 정적 멤버 클래스 -> 바깥클래스의 인스턴스 메소드에서 객체 생성 가능
		 */
		B var1 = new B();
		C var2 = new C();
	}
	...
	//정적 필드
	/*
	 * 인스턴스 멤버 클래스 -> 바깥클래스에서 정적 필드로 선언 불가능
	 * 정적 멤버 클래스 -> 바깥클래스에서 정적 필드로 선언 가능
	...
	static void staticMethod() {
		/*
		 * 인스턴스 멤버 클래스 -> 바깥클래스의 정적 메소드에서 객체 생성 불가능
		 * 정적 멤버 클래스 -> 바깥클래스의 정적 메소드에서 객체 생성 가능
		 */
		//B var1 = new B();
		C var2 = new C();
	}
