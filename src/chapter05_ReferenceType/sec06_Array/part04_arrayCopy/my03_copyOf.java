...
public class my03_copyOf {
	...
	public static void main(String[] args) {
		...
		/* [ Arrays.copyOf(원본배열, 복사개수) ]
		 * 	 - 리턴타입 : 타겟 배열
		 *  - 원본배열의 0번 인덱스에서 복사할 길이 만큼 복사한 배열을 리턴한다.
		...
		//44, 21, 59, 90, 0, 0, 0 ,0을 복제해서 target 배열에 담는다.
		int[] target = Arrays.copyOf(source, 8);
